...
@interface DeliveryAddressViewController ()<ComboBoxViewDelegate,UITextFieldDelegate>
...
-(void)savePushBarButtonHandle{
    ...
    if (self.provinceComboBox.comboxTitle !=nil
        ...
        NSString *urlString = [BaseUrl stringByAppendingString:Customer_AddAddress];//请求地址
        NSLog(@"地址：%@",urlString);
        //配置请求参数
        NSDictionary *params = @{@"ShopName":self.shopNameTextField.text,
        ...
        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"温馨提示" message:@"请填写信息完整" preferredStyle:UIAlertControllerStyleAlert];
