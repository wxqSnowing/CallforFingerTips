...
#import "MonthNewCollectionViewCell.h"

@interface MonthNewViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
...
@implementation MonthNewViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"每月新品";
    ...
    //配置请求参数
    NSDictionary *params = @{@"goodsStatusCode":@"2",
                             @"pageIndex":@"1",
                             @"pageSize":@"20"};
    //block发送请求
...
-(void)addCollectionView{
    ...
    [self.collectionView registerClass:[MonthNewCollectionViewCell class] forCellWithReuseIdentifier:@"AllProCollectionViewCell"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    MonthNewCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"AllProCollectionViewCell" forIndexPath:indexPath];
